...
<body bgcolor="cyan">
	...
	<br>
	<center>
		<h1>Budget Initiate</h1>
		<form action="InitBudget" method="post">
			...
			</select> <br><br> Year: <select name="year">
			...
			</select> <br><br> Amount: <input type="text" name="amount"> <br> <br>
			Issue Date:<select name="DD">
				<option>DD</option>
				...
				<option value="2019">2019</option>
				<option value="2020">2020</option>
			</select> <br> <br> <input type="submit" value="init">
		</form>
	</center>
</body>
</html>