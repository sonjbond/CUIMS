...
<title>Delete Purchase Info</title>
</head>
<body bgcolor="cyan">
	...
	<br>
	<center>
		<form action="DeleteSelectedPurchase" method="post">
			...
			<%
				...
				if (data.size() != 0) {
					...
					out.print("<br> <strong> Purchase Info </strong> <br> <br> Select which one You want to Delete and Click Delete!<br>");
					...
					for (int i = 0; i < data.size(); i++) {
						...
						System.out.println("Button"+i+":  Going to servlet");
