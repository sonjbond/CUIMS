...
<body bgcolor="cyan">
	...
	<center>
		<form action="ReportGenerate" method="post">
			<strong><font size=5 >Generate Report</font></strong> <br>
			<strong><font size=3 >Please Enter Department Name and Year</font></strong>
			<br>
		...
		<br><br><br><h4> <a href=AdminHome.jsp> Back to Home </a></h4>
	</center>
</body>
</html>