...
<title>Delete Sent Equipment Info</title>
</head>
<body bgcolor="cyan">
	...
	<br>
	<center>
		<form action="DeleteSentInfo" method="post">
			<strong><font size=5 > Delete Sent Equipment Info</font></strong> <br>
			<strong><font size=3 >Please Enter Required Info To Select and Delete</font></strong>
			<br><br>
			Department: <select name="Department" style="width: 127px; ">
			...
			<br> Year: <select name="Year" style="width: 91px; ">
