...
<body bgcolor="cyan">
	...
	<center>
		<%
			...
			if(Del.equals("true")){
				out.print("<br> <strong> Sent Equipment Info Successfully Deleted from the Database</strong><br>");
			}
			else{
				out.print("<br> <strong> Sent Equipment Info Can not be Deleted from the Database</strong><br>");
			}
		 %>
	</center>
</body>
